// Headless Three.js house-tour sample -> out/photoreal/3.mp4
//
...
// ffmpeg. Everything is hardcoded; run with:  node photoreal/render_house3.mjs
...
const OUT = path.join(ROOT, "..", "out", "photoreal", "3.mp4");
...
<body><script type="module" src="/house3.js"></script></body>`;
