// Headless Three.js house-tour sample -> out/photoreal/1.mp4
//
...
// ffmpeg. Everything is hardcoded; run with:  node photoreal/render_house.mjs
...
const OUT = path.join(ROOT, "..", "out", "photoreal", "1.mp4");
